                    ...
                    <div class="col-md-12 col-vlg-7">
                      <ul class="cbp_tmtimeline">
                        <?php foreach ($tasks as $task): ?>
                          <li>
                            <time class="cbp_tmtime" datetime="<?php echo $task['datetime']?>">
                              <span class="date"><?php echo $task['day']?></span>
                              <span class="time"><?php echo $task['time']?> <span class="semi-bold"><?php echo $task['am/pm']?></span>
                            </time>
                            <div class="cbp_tmicon primary animated bounceIn"> <i class="fa fa-<?php echo $task['icon']?>"></i> </div>
                            <div class="cbp_tmlabel">
                              <div class="p-t-10 p-l-30 p-r-20 p-b-20 xs-p-r-10 xs-p-l-10 xs-p-t-5">
                                ...
                                <h4 class="inline m-b-5"><span class="text-success semi-bold"><?php echo $task['fname']?> <span class="bold"><?php echo $task['lname']?></span></span> </h4>
                                <h5 class="inline muted semi-bold m-b-5">@<?php echo $task['company']?></h5>
                                <!-- <div class="muted">Completed</div> -->
                                <p class="m-t-5 dark-text"> <?php echo $task['title']?></p>
                              </div>
                              <div class="clearfix"></div>
