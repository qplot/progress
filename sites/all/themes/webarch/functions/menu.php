...
// function zen_progress_preprocess_menu_tree(&$variables) {
//   kpr($variables);
// }
...
function webarch_menu_tree($variables) {
...
*/
function webarch_menu_link(array $variables) {
  ...
  // decorate the title
  $title = '<span class="title">' . $element['#title'] . '</span>';
  // root got a arrow
  if (!in_array('leaf', $classes)) {
    $title = $title . '<span class="arrow "></span>';
  }
  // icon, currently stored in description
  if (!empty($element['#localized_options']['attributes']['title'])) {
    $title = '<i class="fa ' . $element
['#localized_options']['attributes']['title'] . '"></i>' . $title;
  }
  ...
  return '<li' . drupal_attributes($element['#attributes']) . '>' . $output . $sub_menu . "</li>\n";
    ...
    // <a href="javascript:;"><i class="fa fa-archive"></i> <span class="title">Projects</span> <span class="arrow "></span></a>
